...
from p9_v2_training_pilot import run_bounded_ds_cache_pilot, run_non_training_pilot  # noqa: E402
...
def main() -> None:
    ...
    parser.add_argument("--mode", choices=("non-training", "ds-cache-update"), default="non-training")
    args = parser.parse_args()
    p8 = "/mnt/hdd002/dhnyu/fusedata/models/reduced/formal_plan/p8a_3cb1c49084529987f0244a93/p8acc_c9f16a07275aadfae928d329"
    p9_b = "/mnt/hdd002/dhnyu/fusedata/runtime/p9_b_campaigns/20260903_0539_cfgd128/p9_b_training_matrix.json"
    spec = {
        "configuration_id": args.configuration_id,
        "matrix": p9_b if args.mode == "ds-cache-update" else f"{p8}/hyperparameter_configuration_matrix.json",
    ...
    result = (run_bounded_ds_cache_pilot(spec, args.output)
              if args.mode == "ds-cache-update" else run_non_training_pilot(spec, args.output))
