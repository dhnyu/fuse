...
test_that("research and maintenance pipelines use separate scripts and stores", {
  ...
  expect_setequal(
    ...
    c(
      ...
      "p7_training_contract_files", "training_plan_contract_files", "joint_model_smoke_contract_files",
      ...
      "p7_validation_query_reference", "p7_p6_parent_reference", "p7_immutable_parent_reference",
      "p7_deterministic_training_authority", "p7_geometry_feature_cache", "p7_ddp_initialization_smoke",
      "p7_single_update_smoke", "p7_ddp_reference_acceptance", "p7_resume_equivalence",
      "prototype_training_run", "prototype_validation_retrieval", "prototype_checkpoint_selection",
      "prototype_training_execution_record", "prototype_training_acceptance", "prototype_model_validation",
      ...
      "p9_infrastructure_contract_files", "p9_infrastructure_readiness",
      "p9_formal_authorization_contract_files", "p9_formal_accepted_parent_references",
      "p9_production_cache_plan_bundle", "p9_cache_reuse_graph",
      "p9_cache_identity_contract", "p9_cache_resource_plan", "p9_cache_shard_plan",
      "p9_production_cache_build_authority", "p9_production_cache_materialization",
      "p9_production_cache_validation", "p9_formal_publication_bundle",
      ...
      "p9_corrected_formal_publication_bundle", "p9_formal_execution_supersession",
