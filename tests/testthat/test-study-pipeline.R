...
test_that("research and maintenance pipelines use separate scripts and stores", {
  ...
  expect_equal(
    ...
    c(
      "spatial_acceptance_contract_files", "training_plan_contract_files", "membership_contract_files",
      "research_config_files", "relation_contract_files", "research_implementation_files",
      "serialization_plan_contract_files", "observation_contract_files", "serialization_shard_contract_files",
      "dataloader_smoke_contract_files", "augmentation_benchmark_contract_files",
      "training_dataset_acceptance_contract_files", "raster_observation_contract_files", "encoder_smoke_contract_files",
      ...
      "prototype_scientific_geometry_roundtrip", "prototype_augmentation_benchmark", "prototype_training_plan"
    )
  )
