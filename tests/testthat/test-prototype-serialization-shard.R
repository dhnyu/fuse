test_that("I15 serialization shard contract is fixed", {
  ...
  expect_equal(config$scientific$identity$serialization_plan_id, "psp_c3f6659d47486417567d55c1")
  expect_equal(config$scientific$identity$serialization_dataset_id, "psd_c3f6659d47486417567d55c1")
  ...
  expect_equal(unlist(config$scientific$archive$member_order), c(
    "meta.json", "entities.safetensors", "geometry.safetensors", "edges.safetensors", "rasters.safetensors"
  ))
})
