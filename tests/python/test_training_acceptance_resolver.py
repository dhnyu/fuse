...
from training_acceptance import (  # noqa: E402
...
from artifact_protocol import canonical_json_bytes, canonical_sha256, parse_canonical_json, sha256_bytes  # noqa: E402
from training_finalization import finalize_run_bundle  # noqa: E402
...
def test_inconsistent_existing_acceptance_fails_closed(tmp_path):
    ...
    result = finalize_run_bundle(bundle.path, fixture.locator_roots)
    authority = fixture.inputs.authority
    from training_acceptance import _make_acceptance
