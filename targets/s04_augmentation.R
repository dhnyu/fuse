...
list_s04_augmentation <- list(
  ...
  targets::tar_target(s04_bank_road_validation,
    p4_run_smoke("road", s04_bank_profile_plan, s03_scene_dataset_acceptance, s04_bank_sources),
    format = "file", resources = controller_05_resources),
  targets::tar_target(s04_bank_geometry_validation,
    p4_run_smoke("geometry", s04_bank_profile_plan, s03_scene_dataset_acceptance, s04_bank_sources),
    format = "file", resources = controller_05_resources),
  ...
  targets::tar_target(s04_bank_acceptance,
    p4_consolidated_acceptance(s04_bank_shard_plan, s04_bank_validated_shard,
      s03_scene_dataset_acceptance, s04_bank_sources),
    format = "file", resources = controller_05_resources)
)
