"""Read-only logical projection of a current accepted prepared-view cache."""
...
def _cache_sha256(value: Any) -> str:
    """Compute the deterministic prepared-cache identity."""
...
class ProductionPreparedData:
    ...
    def __init__(self, root: str | Path, profile: str, logical_k: int):
        ...
        if len(self.validation_scenes) != 1_000:
