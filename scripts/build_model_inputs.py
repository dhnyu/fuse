...
from model_data import (GEOMETRY_LAYOUT_VERSION, ArtifactCatalog, ArtifactDataset, build_vocabulary, canonical_json_bytes,
...
from scene_model import ReducedSceneEncoder, geometry_fourier_features, parameter_counts
...
def build_architecture(args: argparse.Namespace) -> None:
    ...
    implementation_sha = _sha(ROOT / "python/scene_model.py")
    value = {
...
def build_preprocessing(args: argparse.Namespace) -> None:
    ...
    preprocessing.update({"schema_version": "1.0.0", "status": "PASS", "p3_cache_id": config["parents"]["p3_cache_id"],
                          "scene_order": "scene_id_then_local_entity_id", "implementation_sha256": _sha(ROOT / "python/model_data.py")})
...
def build_dataloader_acceptance(args: argparse.Namespace) -> None:
    ...
    value = {"schema_version": "1.0.0", "geometry_layout_version": GEOMETRY_LAYOUT_VERSION,
             ...
             "invariants": invariants, "implementation_sha256": _sha(ROOT / "python/model_data.py")}
...
def run_smoke(args: argparse.Namespace) -> None:
    ...
    from model_data import DeterministicSceneSampler
