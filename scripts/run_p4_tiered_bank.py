...
def main() -> None:
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=args.workers) as pool:
        pending = {pool.submit(run_branch, path, staging_root, root / "scripts/p4_build_fixed_bank.py",
                               root / "scripts/p4_validate_fixed_bank.py", args.pass_name, args.workers): path
                   for path in specs}
        while pending:
