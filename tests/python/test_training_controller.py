...
from artifact_protocol import canonical_json_bytes, sha256_file  # noqa: E402
...
def authority():
    return build_training_authority(configuration_id="ofat_d_64", configuration_hash="c" * 64,
...
def test_control_plane_module_has_no_scientific_runtime_imports():
    source = (ROOT / "python/training_controller.py").read_text(encoding="utf-8")
