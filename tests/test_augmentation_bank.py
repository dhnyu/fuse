...
import augmentation_bank as p4
import smoke_test_augmentation


def test_receiver_group_and_entity_fallback_smokes():
    assert smoke_test_augmentation.road_smoke()["status"] == "PASS"
    assert smoke_test_augmentation.fallback_smoke()["status"] == "PASS"
