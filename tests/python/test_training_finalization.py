...
from training_bundle import build_run_bundle, publish_run_bundle  # noqa: E402
from training_bundle_test_support import make_bundle_fixture  # noqa: E402
from training_c_test_support import CandidateSpec, make_published_case  # noqa: E402
from artifact_protocol import canonical_sha256  # noqa: E402
from training_finalization import (  # noqa: E402
    finalize_run_bundle,
    make_selection_contract,
    validate_finalization_result,
)
from training_schema import TrainingSchemaError, validate_instance  # noqa: E402
...
def test_finalizer_version_is_identity_bound(tmp_path):
    fixture, bundle = _simple(tmp_path)
    first = finalize_run_bundle(bundle, fixture.locator_roots)
    second = finalize_run_bundle(bundle, fixture.locator_roots, finalizer_version="current-training-finalizer-v1-test")
...
def test_selection_and_result_schemas_accept_valid_reject_invalid(tmp_path):
    ...
    with pytest.raises(TrainingSchemaError):
...
def test_finalizer_import_boundary_has_no_training_stack():
    code = (
        "import sys; sys.path.insert(0, 'python'); import training_finalization; "
